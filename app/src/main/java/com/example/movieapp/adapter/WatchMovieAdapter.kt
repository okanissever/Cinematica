...
class WatchMovieAdapter() : ListAdapter<Result, WatchMovieAdapter.MovieHolder>(NoteDiffCallback) {
    ...
    class MovieHolder(val binding : ItemTopMovieBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onBindViewHolder(holder: MovieHolder, position: Int) {
        ...
        holder.binding.textNumber.text = (position+1).toString()
